...
public class SpaceUserServiceImpl extends ServiceImpl<SpaceUserMapper, SpaceUser>
    ...
    public long addSpaceUser(SpaceUserAddRequest spaceUserAddRequest) {
        ...
        ThrowUtils.throwIf(!result, ErrorCode.OPERATION_ERROR, "用户已存在或其他未知错误");
    ...
    @Override
    public void checkSpaceUser(Long userId, Long spaceId) {
        ThrowUtils.throwIf(userId == null || spaceId == null || spaceId <= 0, ErrorCode.PARAMS_ERROR);
