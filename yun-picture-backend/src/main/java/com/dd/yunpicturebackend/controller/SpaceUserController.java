...
import com.dd.yunpicturebackend.model.dto.spaceuser.SpaceUserEditRequest;
...
public class SpaceUserController {
    ...
    public BaseResponse<Long> addSpaceUser(@RequestBody SpaceUserAddRequest spaceUserAddRequest, HttpServletRequest request) {
        ...
        spaceUserService.checkSpaceUser(loginUser.getId(), spaceUserAddRequest.getSpaceId());
    ...
    public BaseResponse<Boolean> deleteSpaceUser(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        // 校验权限
        User loginUser = userService.getLoginUser(request);
        spaceUserService.checkSpaceUser(loginUser.getId(), oldSpaceUser.getSpaceId());
        // 操作数据库
    ...
    public BaseResponse<SpaceUser> getSpaceUser(@RequestBody SpaceUserQueryRequest spaceUserQueryRequest, HttpServletRequest request) {
        ...
        // 校验权限
        User loginUser = userService.getLoginUser(request);
        spaceUserService.checkSpaceUser(loginUser.getId(), spaceUserQueryRequest.getSpaceId());
        // 查询数据库
